...
class TestFrame(unittest.TestCase):
    ...
    @testdata.TestData([
        ...
        {'op': Frame.Operation.GetParameter, 'length': 53},
        {'op': Frame.Operation.GetRecord,    'length': 54},
        {'op': Frame.Operation.GetRecord,    'length': 55},
    ])
    ...
    @testdata.TestData([
        ...
        {'op': Frame.Operation.SetParameter, 'length': 55},
    ])
    ...
    @testdata.TestData([
        {'op': Frame.Operation.GetParameter, 'offset':         0, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x10])},
        {'op': Frame.Operation.GetParameter, 'offset':         0, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x10])},
        {'op': Frame.Operation.GetParameter, 'offset':         0, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x33, 0x41])},
        {'op': Frame.Operation.GetParameter, 'offset':      0xFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0x00, 0xFE, 0x00, 0x02, 0x0E])},
        {'op': Frame.Operation.GetParameter, 'offset':      0xFF, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x02, 0x0F])},
        {'op': Frame.Operation.GetParameter, 'offset':      0xFF, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x33, 0x40])},
        {'op': Frame.Operation.GetParameter, 'offset':    0xFFFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0xFF, 0xFE, 0x00, 0x02, 0x0D])},
        {'op': Frame.Operation.GetParameter, 'offset':    0xFFFF, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x02, 0x0E])},
        {'op': Frame.Operation.GetParameter, 'offset':    0xFFFF, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x33, 0x3F])},
        {'op': Frame.Operation.GetParameter, 'offset':  0xFFFFFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0xFF, 0xFE, 0xFF, 0x02, 0x0C])},
        {'op': Frame.Operation.GetParameter, 'offset':  0xFFFFFF, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x02, 0x0D])},
        {'op': Frame.Operation.GetParameter, 'offset':  0xFFFFFF, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x03, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x33, 0x3E])},
        {'op': Frame.Operation.GetRecord,    'offset':         0, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x0D])},
        {'op': Frame.Operation.GetRecord,    'offset':         0, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x0E])},
        {'op': Frame.Operation.GetRecord,    'offset':         0, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x33, 0x3F])},
        {'op': Frame.Operation.GetRecord,    'offset':      0xFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x01, 0x0C])},
        {'op': Frame.Operation.GetRecord,    'offset':      0xFF, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x02, 0x0D])},
        {'op': Frame.Operation.GetRecord,    'offset':      0xFF, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x33, 0x3E])},
        {'op': Frame.Operation.GetRecord,    'offset':    0xFFFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x01, 0x0B])},
        {'op': Frame.Operation.GetRecord,    'offset':    0xFFFF, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x02, 0x0C])},
        {'op': Frame.Operation.GetRecord,    'offset':    0xFFFF, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x33, 0x3D])},
        {'op': Frame.Operation.GetRecord,    'offset':  0xFFFFFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x01, 0x0A])},
        {'op': Frame.Operation.GetRecord,    'offset':  0xFFFFFF, 'length':  2, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x02, 0x0B])},
        {'op': Frame.Operation.GetRecord,    'offset':  0xFFFFFF, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x0C, 0x01, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x33, 0x3C])},
    ])
    ...
    @testdata.TestData([
        {'op': Frame.Operation.SetParameter, 'offset':         0, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0D, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,    0x00,    0x11])},
        {'op': Frame.Operation.SetParameter, 'offset':      0xFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0D, 0x04, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x01,    0x00,    0x10])},
        {'op': Frame.Operation.SetParameter, 'offset':    0xFFFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0D, 0x04, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x01,    0x00,    0x0F])},
        {'op': Frame.Operation.SetParameter, 'offset':  0xFFFFFF, 'length':  1, 'expected': bytes([0x33, 0xCC, 0x00, 0x0D, 0x04, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x01,    0x00,    0x0E])},
        {'op': Frame.Operation.SetParameter, 'offset':         0, 'length': 51, 'expected': bytes([0x33, 0xCC, 0x00, 0x3F, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x33] + [0]*51 + [0x75])},
    ])
    ...
    def testParseIncompleteHeader(self, op):
        frame = Frame(op, 0, 2)
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C, op.value, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, op.value + 0x0D]))
        with self.assertRaises(ValueError) as e:
    ...
    def testParseSetParameterMissingData(self, op, o, l):
        ...
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C + l, op.value, 0x00, 0x00, o >> 8, o & 0xFF, 0x00, l] + list(range(1, l + 1)) + [(op.value + (o >> 8) + (o & 0xFF) + 2*l + l*(l + 1)//2 + 0x0B) & 0xFF]))
        with self.assertRaises(ValueError) as e:
    ...
    def testParseGetParameterOffsetMismatch(self, op, o1, o2):
        frame = Frame(op, o1, 2)
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C, op.value, 0x00, 0x00, o1 >> 8, o1 & 0xFF, 0x00, 0x02, (op.value + (o1 >> 8) + (o1 & 0xFF) + 0x0D) & 0xFF]))
    ...
    def testParseSetParameterOffsetMismatch(self, op, o1, o2):
        ...
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0D, op.value, 0x00, 0x00, o1 >> 8, o1 & 0xFF, 0x00, 0x01, 0x00, (op.value + (o1 >> 8) + (o1 & 0xFF) + 0x0D) & 0xFF]))
        with self.assertWarns(UserWarning) as w:
    ...
    @testdata.TestData([
        ...
        {'op': Frame.Operation.GetParameter, 'l1': 0x34, 'l2': 0x33},
        {'op': Frame.Operation.GetParameter, 'l1': 0x33, 'l2': 0x34},
    ])
    def testParseGetParameterLengthMismatch(self, op, l1, l2):
        frame = Frame(op, 0, l1)
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C, op.value, 0x00, 0x00, 0x00, 0x00, 0x00, l1, (op.value + l1 + 0x0B) & 0xFF]))
        with self.assertWarns(UserWarning) as w:
    ...
    def testParseSetParameterLengthMismatch(self, op, l):
        ...
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C + l, op.value, 0x00, 0x00, 0x00, 0x00, 0x00, l] + list(range(1, l + 1)) + [(op.value + 2*l + l*(l + 1)//2 + 0x0B) & 0xFF]))
        with self.assertWarns(UserWarning) as w:
    ...
    @testdata.TestData([
        ...
        {'op': Frame.Operation.GetParameter, 'l': 0x34},
        {'op': Frame.Operation.GetParameter, 'l': 0x33},
    ])
    def testParseGetParameterMissingChecksum(self, op, l):
        frame = Frame(op, 0, l)
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C, op.value, 0x00, 0x00, 0x00, 0x00, 0x00, l, (op.value + l + 0x0B) & 0xFF]))
        with self.assertWarns(UserWarning) as w:
    ...
    def testParseSetParameterMissingChecksum(self):
        ...
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0D, op.value, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, (op.value + 0x0D) & 0xFF]))
        with self.assertWarns(UserWarning) as w:
    ...
    def testParseSetParameterInvalidChecksum(self):
        op = Frame.Operation.SetParameter
        frame = Frame(op, 0, b'\0')
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0D, op.value, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, op.value + 0x0D]))
        with self.assertWarns(UserWarning) as w:
    ...
    def testParseGetRecordInvalidChecksum(self):
        op = Frame.Operation.GetRecord
        frame = Frame(op, 0, 1)
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C, op.value, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, op.value + 0x0C]))
        with self.assertWarns(UserWarning) as w:
    ...
    def testParseGetParameterRead1Response(self, op, offset):
        ...
        self.assertEqual(bytes(frame), bytes([0x33, 0xCC, 0x00, 0x0C, op.value, 0x00, 0x00, o >> 8, o & 0xFF, 0x00, 0x02, (op.value + (o >> 8) + (o & 0xFF) + 0x0D) & 0xFF]))
